...
public class Alumno {
	...
	//@JsonIgnore //No convertir el atributo a JSON. Ya no hace falta
	@ManyToMany()
	@JoinTable(name = "matriculas", 
	joinColumns = @JoinColumn(name = "usuario", referencedColumnName = "usuario"), 
	inverseJoinColumns = @JoinColumn(name = "idCurso", referencedColumnName = "idCurso")) //Ignoramos el atributo NOTA en matricula
